<script>
  ...
  let input = ''
  // let errorIndexes = []
  // let takenWordIndexes = []
  // let takenTranslationIndexes = []
  // let selectedWords = []
...
<div class="flex flex-col h-full gap-5 overflow-auto rounded-3xl">
  <ReviewerSection title="Word">
    <ReviewerSentence
      sentence={{ words: card.front.concept.sentence }}
      isCentered
    />
  </ReviewerSection>
  <input
    class="input text-black p-4 rounded-3xl bg-white resize-none"
    placeholder="Translate the Word"
    bind:value={input}
  /> 
  <ReviewerSection title="Context">
    <ReviewerSentence sentence={{ words: card.front.sentence.sentence }} title="Context"/> 
  </ReviewerSection>
  <textarea
...
<!-- <ReviewSentence sentence={{ words: card.front.concept.sentence }} title="Context"/>
<ReviewSentence sentence={{ words: card.front.sentence.sentence }} title="Context"/> -->
<!-- {#if !isFlipped}
